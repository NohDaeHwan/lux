...
public class ProductService {
    ...
    public Page<ProductDto> frontProductFind(String productColor, String productBrand, String productGender,
            String productSize,
        ...
        return productRepository.findByFrontProductList(productColor, productBrand,
                productGender, productSize, productGrade, Integer.parseInt(maxPrice), Integer.parseInt(minPrice), query,
    ...
    // 카테고리 중고 검색
    @Transactional(readOnly = true)
    public List<ProductDto> catesearch(Long mcategoryId, String productColor, String productBrand, String productGender,
            String productSize, String productGrade, String maxPrice, String minPrice, String query) {
        return productRepository
                .searchProductBy(mcategoryId, productBrand, productColor, productGender, productSize, productGrade,
                        Integer.parseInt(maxPrice), Integer.parseInt(minPrice), query)
                .stream()
    ...
    public List<ProductDto> findByState6AndRecent4List() {
        return productRepository.findByState6AndRecent4List().stream().map(ProductDto::from)
