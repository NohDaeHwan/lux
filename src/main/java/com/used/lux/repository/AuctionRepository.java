...
//카테고리 서치
    @Query(value ="select a from Auction a where a.product.appraisal.appraisalRequest.appraisalBrand.brandName Like %:brandName% AND a.product.categoryM.id =:mcategoryId and " +
    ...
    List<Auction> searchAuctionBy(String brandName,Long mcategoryId, String productColor,String productGender,String productSize, int maxPrice,int minPrice);
