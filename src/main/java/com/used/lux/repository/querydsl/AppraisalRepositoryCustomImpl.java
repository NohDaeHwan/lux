...
public class AppraisalRepositoryCustomImpl extends QuerydslRepositorySupport implements AppraisalRepositoryCustom {
    ...
    public Page<Appraisal> searchAppraise(String appraisalState, String appraisalBrand, String appraisalGender,
        ...
        JPQLQuery<Appraisal> queryResult = from(appraisal)
                .select(appraisal)
                .where(appraisal.appraisalState.stateStep.like("%"+appraisalState+"%"),
                        appraisal.appraisal.appraisalBrand.brandName.like("%"+appraisalBrand+"%"),
                        appraisal.appraisal.appraisalGender.like("%"+appraisalGender+"%"),
                        appraisal.appraisal.appraisalSize.like("%"+appraisalSize+"%"),
                        appraisal.appraisal.appraisalGrade.like("%"+appraisalGrade+"%"),
                        appraisal.appraisal.appraisalProductName.like("%"+query+"%"),
